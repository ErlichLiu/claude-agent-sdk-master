# Claude Agent SDK 系列教程 - 第二章：工具调用与 MCP 集成

> **🎯 教程定位**
> 本教程是 **Claude Agent SDK 系列教程的第二部分**，在第一章的基础上，深入探讨如何通过工具调用（Tool Use）和 MCP（Model Context Protocol）集成，赋予 Agent 真正的能力。
...
- **第一章**：快速入门 - 核心概念与基础对话 ✅
- **第二章（本章）**：工具调用 - 集成 MCP Tools，实现 Agent 能力 ⏳
...
> **⚠️ 前置要求**
> 本章假设你已经完成第一章的学习，理解了 Workspace、Session 和流式响应等核心概念。
